...
elseif CoreGui:FindFirstChild("RobloxGui") then
	YSSH.Parent = CoreGui:FindFirstChild("RobloxGui")
else
	YSSH.Parent = CoreGui
end
...
function YSSHLibrary:LoadConfiguration()
	if CEnabled then
		pcall(function()
			if isfile(ConfigurationFolder .. "/" .. CFileName .. ConfigurationExtension) then
				LoadConfiguration(readfile(ConfigurationFolder .. "/" .. CFileName .. ConfigurationExtension))
				YSSHLibrary:Notify({Title = "Configuration Loaded", Content = "The configuration file for this script has been loaded from a previous session"})
			end
		end)
	end
end

task.delay(3.5, YSSHLibrary.LoadConfiguration, YSSHLibrary)
if YSSH:FindFirstChild("Notice") then
	YSSH.Notice.Visible = true
	YSSH.Notice.Interact.MouseButton1Click:Connect(function()
		YSSH.Notice.Visible = false
	end)
end
